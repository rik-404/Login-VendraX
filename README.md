...
```
├── index.html             # Página principal de entrada (raiz)
├── src/                   # Código fonte do projeto
│   ├── pages/            # Páginas HTML secundárias
│   │   ├── index.html    # Tela principal de seleção de perfis (cópia)
...
│   │   └── theme.js      # Funcionalidades de tema
│   ├── components/       # Componentes reutilizáveis (futuro)
│   ├── utils/            # Utilitários e helpers (futuro)
│   └── assets/           # Recursos estáticos
│       └── images/       # Imagens dos perfis
│           ├── perfil-1.jpg
│           ├── perfil-2.jpg
│           ├── perfil-3.jpg
│           └── perfil-4.jpg
...
### 1. Seleção de Perfil
- Acesse `index.html` (raiz do projeto) ou `public/index.html` (redirecionamento)
...
### Alterar Perfis
Edite os links em `index.html` (raiz) ou `src/pages/index.html`:
```html
<a href="src/pages/login.html?image=src/assets/images/perfil-1.jpg&name=Seu%20Nome">
```

### Mudar Senha Padrão
Altere em `src/scripts/login.js`:
```javascript
...
### Personalizar Cores
Modifique as variáveis em `src/styles/style.css`:
```css
:root {
